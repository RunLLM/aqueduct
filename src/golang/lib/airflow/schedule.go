...
func ScheduleWorkflow(
	...
	// Unlike the above, storage path prefixes for operator metadata cannot be pre-generated,
	// because the metadata path is generated by the `NewOperator` constructor. The following
	// map stores these path prefixes after each Operator has been constructed and the prefixes
	// have been generated.
