...
type NullServicePorts struct {
	ServicePorts
	IsNull bool
}

func (n *NullServicePorts) Scan(value interface{}) error {
	if value == nil {
		// ServicePorts is NULL
		n.IsNull = true
		return nil
	}

	servicePorts := &ServicePorts{}
	if err := servicePorts.Scan(value); err != nil {
		return err
	}

	n.ServicePorts, n.IsNull = *servicePorts, false
	return nil
}
