		...
		connectIntegrationArgs := &ConnectIntegrationArgs{
			...
			Config: auth.NewStaticConfig(
				map[string]string{
					...
					shared.K8sKeepaliveKey:          strconv.FormatInt(int64(shared.K8sDefaultKeepalive), 10),
					shared.K8sCpuNodeTypeKey:        shared.K8sDefaultCpuNodeType,
					shared.K8sGpuNodeTypeKey:        shared.K8sDefaultGpuNodeType,
					shared.K8sMinCpuNodeKey:         strconv.FormatInt(int64(shared.K8sDefaultMinCpuNode), 10),
					shared.K8sMaxCpuNodeKey:         strconv.FormatInt(int64(shared.K8sDefaultMaxCpuNode), 10),
					shared.K8sMinGpuNodeKey:         strconv.FormatInt(int64(shared.K8sDefaultMinGpuNode), 10),
					shared.K8sMaxGpuNodeKey:         strconv.FormatInt(int64(shared.K8sDefaultMaxGpuNode), 10),
				},
			),
			UserOnly:     false,
			SetAsStorage: false,
