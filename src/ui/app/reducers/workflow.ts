...
import { GetArtifactResultResponse } from '@aqueducthq/common/src/utils/artifacts';
import { GetOperatorResultResponse } from '@aqueducthq/common/src/utils/operators';
...
} from '@aqueducthq/common/src/utils/workflows';
