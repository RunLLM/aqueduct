...
const App = () => {
  ...
  routesContent = (
    <Routes>
      ...
      <Route path={`/${pathPrefix}/workflow/:workflowId/dag/:workflowDagId/metric/:metricOperatorId`} element={<RequireAuth user={user}><MetricDetailsPage user={user} /> </RequireAuth>} />
      <Route path={`/${pathPrefix}/workflow/:workflowId/dag/:workflowDagId/check/:checkOperatorId`} element={<RequireAuth user={user}><CheckDetailsPage user={user} /> </RequireAuth>} />
