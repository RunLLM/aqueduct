...
import {setBottomSideSheetOpenState, setRightSideSheetOpenState} from "../reducers/openSideSheet";
...
export function getDataSideSheetContent(user: UserProfile, currentNode: SelectedNode): React.ReactElement {
