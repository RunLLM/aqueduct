...
import { faBook, faEnvelope, faThumbsUp } from '@fortawesome/free-solid-svg-icons';
...
const GettingStartedTutorial: React.FC<GettingStartedTutorialProps> = ({ user }) => {
        ...
        >
            ...
            >
                {user && (
                    ...
                    >
                        ...
                        <Typography variant="h6">Here&apos;s how you can get started with Aqueduct.</Typography>

                        <Box sx={{ textAlign: 'left', mr: '16px' }}>
                            <ol>
                                <li>
                                    <Typography variant="body1">
                                        First go to the <Link href="/integrations">integrations</Link> page and connect
                                        a database. (If you don&apos;t have a database handy, you can use the{' '}
                                        <code>aqueduct_demo</code> database -- see the documentation{' '}
                                ...
                                <li>
                                    <Typography variant="body1">
                                        Go to the <Link href="/workflows">workflows</Link> page to see a visualization
                                        of the workflow you just created.
                                    </Typography>
                                </li>
                            </ol>
                        </Box>
            ...
            <InfoCard sx={{ backgroundColor: 'gray.50' }}>
                ...
                <Typography variant="h6">
                    ...
                    <Link href="mailto:support@aqueducthq.com">support@aqueducthq.com</Link>.
                </Typography>
            </InfoCard>
