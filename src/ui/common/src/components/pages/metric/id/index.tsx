            ...
            <Box width={'800px'}>
                <Box width="100%">
                    ...
                    <Box display="flex" width="100%" paddingTop="40px">
                        <Box width="100%">
                            <Typography variant="h5" component="div" marginBottom="8px">Inputs:</Typography>
                            {/* TODO: add accordion here for inputs to the metric. */}
                            <Accordion expanded={true} onChange={() => { console.log('on accordion change') }}>
                                <AccordionSummary
                                    expandIcon={<FontAwesomeIcon icon={faChevronRight} />}
                                    aria-controls="panel1bh-content"
                                    id="panel1bh-header"
                                >
                                    <Typography sx={{ width: '33%', flexShrink: 0 }} variant="h5" component="div" marginBottom="8px">
                                        Inputs
                                    </Typography>
                                </AccordionSummary>
                                <AccordionDetails>
