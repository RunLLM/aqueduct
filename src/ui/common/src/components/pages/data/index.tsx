    ...
    return (
        <Autocomplete
            ...
            renderInput={(params) => {
                ...
                return <TextField {...params} label="Search" variant="standard" onChange={onChangeFn} />;
            }}
...
const DataPage: React.FC<Props> = ({ user }) => {
    ...
    const dataCardsInfo = useSelector((state: RootState) => state.dataPreviewReducer);
    ...
    return (
        <DefaultLayout user={user}>
            ...
            <Box>
                ...
                {SearchBar(Object.values(dataCardsInfo.data.latest_versions), (e) => setFilterText(e.target.value))}

                <Box sx={{ my: 3, ml: 1 }}>
                    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', my: 1 }}>
