...
const DataPreviewSideSheet: React.FC<Props> = ({ artifactId }) => {
    ...
    const artifactResult = useSelector((state: RootState) => state.workflowReducer.artifactResults[artifactId]);
    ...
    const operatorResult = useSelector((state: RootState) => state.workflowReducer.operatorResults[operatorId]);
