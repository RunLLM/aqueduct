  ...
  return (
    <Box style={menuSidebar}>
      ...
      <Box style={menuSidebarFooter}>
        <Divider sx={{ width: '64px', backgroundColor: 'white' }} />
        <Box sx={{ my: 2 }}>
          <Link href="https://docs.aqueducthq.com" underline="none" target="_blank" rel="noreferrer noopener">
            <SidebarButton
              onClick={() => {
                if (onSidebarItemClicked) {
        ...
        <Divider sx={{ width: '64px', backgroundColor: 'white' }} />
        <Box sx={{ my: 2 }}>
          <Link href="mailto:support@aqueducthq.com" underline="none" target="_blank" rel="noreferrer noopener">
            <SidebarButton
              onClick={() => {
                if (onSidebarItemClicked) {
