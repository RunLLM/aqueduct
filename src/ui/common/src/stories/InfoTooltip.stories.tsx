...
RightTooltip.args = {
  tooltipText: "This is the tooltip content. It appears to the right of the button.",
  placement: "right",
};

export const BottomTooltip = Template.bind({});
RightTooltip.args = {
  tooltipText: "This is the tooltip content. It appears to the bottom of the button.",
  placement: "bottom",
};
