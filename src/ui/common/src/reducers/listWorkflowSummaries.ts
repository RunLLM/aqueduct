...
export const handleFetchAllWorkflowSummaries = createAsyncThunk<ListWorkflowSummary[], { apiKey: string }>(
...
export const listWorkflowSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(handleFetchAllWorkflowSummaries.rejected, (state, { payload }) => {
