...
def construct_default_output_artifact_names_from_op(op_name: str, num_outputs: int) -> List[str]:
...
#         candidate_artifact_names = construct_default_output_artifact_names_from_op(
#             op_name, num_outputs
#         )
