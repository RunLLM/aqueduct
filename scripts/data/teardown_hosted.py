...
from .redshift_test import pause_redshift
...
def main():
    ...
    teardown_redshift(aws_access_key_id, aws_secret_access_key)


def teardown_redshift(aws_access_key_id, aws_secret_access_key):
