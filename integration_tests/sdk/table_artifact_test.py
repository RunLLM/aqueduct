...
def test_number_of_missing_values(sp_client):
...
def test_number_of_rows(sp_client):
    db = sp_client.integration(name=get_integration_name())
    table = db.sql(query=SENTIMENT_SQL_QUERY)
