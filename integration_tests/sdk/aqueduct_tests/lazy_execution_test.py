...
@pytest.mark.skip_for_global_lazy_execution(reason="Test doesn't work with lazy execution.")
...
@pytest.mark.skip_for_global_lazy_execution(reason="Doesn't work for global lazy execution.")
