...
def assert_data_integration_is_mongo_db(data_integration):
    assert isinstance(data_integration, MongoDBResource)


def test_mongo_fetch(client, data_integration: MongoDBResource):
...
def test_bad_fetch(client, data_integration: MongoDBResource):
...
def test_mongo_fetch_column_selection(client, data_integration: MongoDBResource):
...
def test_mongo_fetch_with_filter(client, data_integration: MongoDBResource):
    actual_data = (
        data_integration.collection("hotel_reviews")
...
def test_mongo_save_replace(flow_manager: FlowManager, data_integration: MongoDBResource):
...
def test_mongo_save_append(flow_manager: FlowManager, data_integration: MongoDBResource):
...
def test_mongo_artifact_with_custom_metadata(
    flow_manager: FlowManager, data_integration: MongoDBResource
):
...
def test_mongo_preserves_bson_table_even_with_pickled_collection_type(
    flow_manager,
    data_integration: MongoDBResource,
):
