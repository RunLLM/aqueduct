...
### Explore Aqueduct UI
A few minutes after the codespace get connected, we automatically start Aqueduct in this codespace. Once you see the following outputs in your terminal, you can open Aqueduct UI by command-clicking the link.
