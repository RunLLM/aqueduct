...
* [Beta] Aqueduct now has support for on-demand Kubernetes cluster creation and
    ...
    cluster for you. See the documentation [here](https://docs.aqueducthq.com/integrations/on-demand-resources/on-demand-aws-eks-clusters) for how to create an operator that uses on-demand
    Kubernetes.
